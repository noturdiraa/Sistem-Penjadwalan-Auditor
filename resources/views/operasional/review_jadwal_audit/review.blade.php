                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="row g-2 mb-3">
                                            <div class="col-sm-6">
                                                ...
                                                <small class="text-secondary d-block mt-1" style="font-size: 12px;">Poin Keberangkatan: <strong class="{{ $totalAudit === 0 ? 'text-success' : 'text-primary' }}">{{ $totalAudit }} Poin</strong></small>
                                            </div>
                                            <div class="col-sm-6">
