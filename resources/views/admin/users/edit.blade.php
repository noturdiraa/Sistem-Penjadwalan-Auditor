        ...
        <div class="form-box">
            ...
            <form action="{{ route('admin.users.update', $user->id_user) }}" method="POST">
                ...
                <div class="mb-4 text-start">
                    ...
                    <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" value="{{ old('username', $user->username) }}" placeholder="Masukkan username unik..." required>
                    @error('username')
                ...
                <!-- Password (Optional) -->
                <div class="mb-4 text-start">
                    <label for="password" class="form-label">Password <span class="text-secondary fw-normal" style="font-size: 12px;">(Kosongkan jika tidak ingin mengubah password)</span></label>
                    <div class="position-relative">
                        <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" name="password" placeholder="Masukkan password baru..." style="padding-right: 45px;">
                ...
                <div class="mb-4 text-start">
                    ...
                    <div class="position-relative">
                        <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" placeholder="Ulangi password baru..." style="padding-right: 45px;">
                ...
                <div class="mb-5 text-start">
                    ...
                    <select class="form-select @error('role') is-invalid @enderror" id="role" name="role" required>
                        @php
                            ...
                            // Normalize matching case
                            $lowCurrent = strtolower($currentRole);
                        @endphp
                        <option value="Admin" {{ $lowCurrent === 'admin' ? 'selected' : '' }}>Admin</option>
                        <option value="Kepegawaian" {{ $lowCurrent === 'kepegawaian' ? 'selected' : '' }}>Kepegawaian</option>
                        <option value="PJI" {{ $lowCurrent === 'pji' ? 'selected' : '' }}>PJI</option>
                        <option value="Kepala Balai" {{ $lowCurrent === 'kepala balai' ? 'selected' : '' }}>Kepala Balai</option>
                        <option value="Operasional" {{ $lowCurrent === 'operasional' ? 'selected' : '' }}>Operasional</option>
                    </select>
                    @error('role')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="d-flex gap-3 justify-content-start">
                    ...
                    <button type="submit" class="btn btn-primary btn-submit px-4">
                        <i class="fas fa-circle-check me-2"></i> Perbarui User
                    </button>
                </div>
