...
<body>
    ...
    <div class="content">
        ...
        <div class="main">
            ...
            @if(session('error'))
                <div class="alert alert-danger alert-dismissible fade show shadow-sm" role="alert" style="border-radius: 12px; margin-bottom: 25px; border-left: 5px solid #EF4444;">
